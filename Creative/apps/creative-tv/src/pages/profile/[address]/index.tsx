        ...
        <>
          ...
          <Box mt={5}>
            <Tabs variant="enclosed" isFitted>
              <TabList mb="1em">
                <Tab>
                  <span role="img" aria-label="identification">
                    🪪
                  </span>
                  &nbsp;Membership
                </Tab>
                ...
                <Tab>
                  <span role="img" aria-label="camcorder">
                    📹
                  </span>
                  &nbsp;Video Uploads
                </Tab>
                      ...
                      <Box key={nft?.metadata.id.toString()}>
                        <Box display="flex" justifyContent="space-between">
                          <Box flex="0 0 50%" alignItems="center">
                            <MemberCard member={address} nft={nft} balance={ownerBalanceString!} />
                            <Flex
                              ...
                              <Box flex="1" maxW="md" mb={{ base: 4, md: 0 }}>
                                ...
                                <Button
                                  colorScheme="pink"
                                  aria-disabled={transferAddress !== '' ? false : true}
                                  w={32}
                                  onClick={() => {
                                    share()
                                  }}>
                ...
                <TabPanel>
                  <Box mb={5}>
                    ...
                    <Text fontSize={'normal'}>
                      ...
                      viewers can tip you and buy your products within our platform's creative ecosystem. It offers a convenient and integrated method
                      for transactions and supports your growth as a creator.
                    </Text>
                  </Box>
                  {/* <MeTokenCreationForm /> */}
                </TabPanel>
