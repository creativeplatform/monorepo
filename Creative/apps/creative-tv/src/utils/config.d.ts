...
export declare const NEXT_PUBLIC_STUDIO_API_KEY: string;
export declare const SESSION_PASSWORD: string;
export declare const NODE_ENV: string;
export declare const SIWE_SESSION_SECRET: string;
export declare const ALCHEMY_API_KEY: string;
export declare const INFURA_API_KEY: string;
export declare const POLYGONSCAN_API_KEY: string;
export declare const HOST: string;
export declare const SMART_WALLET_KEY: string;
export declare const EXPLORER_KEY: string;
