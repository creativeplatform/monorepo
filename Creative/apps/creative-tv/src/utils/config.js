...
export const THEME_COLOR_SCHEME = 'brand';
...
export const SERVER_SESSION_SETTINGS = {
    ...
    password: (_a = process.env.NEXT_SESSION_PASSWORD) !== null && _a !== void 0 ? _a : 'UPDATE_TO_complex_password_at_least_32_characters_long',
    cookieOptions: {
...
// POLYGON MAINNET THIRDWEB RPC
export const MAINNET_RPC = 'https://polygon.rpc.thirdweb.com';
// VIDEO NFT MUMBAI
